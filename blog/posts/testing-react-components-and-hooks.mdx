export const frontMatter = {
  ...
  summary:
    "Guide to unit testing React components and hooks with user events and browser events using Vitest and @testing-library/react",
...
missed it [here](/blog/getting-started-with-unit-testing-in-JS-TS-and-React) Now that we
...
<Admonition type="warning" title="Skip redundant tests: ">
