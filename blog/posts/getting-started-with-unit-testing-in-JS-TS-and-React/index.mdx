...
2.  Project to test. I provided a repo to get started with [here](https://github.com/JanKaram2020/vitest-tutorial) ( start with main and compare your branch at every step with the "steps" branch) but you can start with any project
