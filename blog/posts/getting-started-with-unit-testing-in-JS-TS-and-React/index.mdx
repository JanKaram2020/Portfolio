...
<Admonition type="note" title={<LangChanger labels={["JS,", "TS", "and React"]} buttonClass={"group-[:not(:hover)]:aria-selected:underline group-hover:hover:underline"} containerClass={"flex flex-row"} variant={"space"}  className={"mt-2"}/>}>
...
<div className={"inline-flex flex-row"}>
  ...
  <LangChanger
    ...
    containerClass={"inline-flex flex-row"}
    variant={"space"}
  />
</div>
